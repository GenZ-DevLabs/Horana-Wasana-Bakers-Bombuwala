...
export default function EditDeletePanel({ name, children }) {
  ...
  return (
    <div>
      ...
      {/* edit */}
      <Link to={`/account/${name}/` + children._id}>
        <button className="cursor-pointer absolute bottom-1 left-1 text-white bg-black p-2 bg-opacity-50 rounded-2xl">
          <svg
